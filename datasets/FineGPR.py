...
class FineGPR(BaseImageDataset):
    ...
    def __init__(self, root=r'/cluster/home/chenhao/vit/TransReID/data', verbose=True, **kwargs):
        super(FineGPR, self).__init__()
        self.dataset_dir = osp.join(root, self.dataset_dir)
        self.train1_dir = r'/cluster/home/chenhao/clip/scripts/datasetmaker/FineGPR_transfer_uniformID'
        self.train2_dir = osp.join(self.dataset_dir, 'bounding_box_train')
        ...
        if verbose:
            ...
            self.print_dataset_statistics(train1, query, gallery)
